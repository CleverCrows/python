...
class Test:
    ...
    def test_channel_up(self):
        """
        TV is off and channel is switched forward
        """
        self.tv1.channel_up()
        assert self.tv1.__str__() == 'Power = [False], Channel = [0], Volume = [0]'
        """
        TV is on and channel is switched forward
        """
        self.tv1.power()
        self.tv1.channel_up()
        assert self.tv1.__str__() == 'Power = [True], Channel = [1], Volume = [0]'
        """
        TV is on and switched to a channel beyond the maximum channel number.
        """
        self.tv1.channel_up()
        self.tv1.channel_up()
        self.tv1.channel_up()
    ...
    def test_channel_down(self):
        ...
        assert self.tv1.__str__() == 'Power = [False], Channel = [0], Volume = [0]'
        """
        TV is on and channel is switched past the minimum channel number.
        """
        self.tv1.power()
        self.tv1.channel_down()
    ...
    def test_volume_up(self):
        ...
        """
        TV is on, and has increased the volume past the maximum value
        """
        self.tv1.volume_up()
        assert self.tv1.__str__() == 'Power = [True], Channel = [0], Volume = [2]'
    ...
    def test_volume_down(self):
        ...
        assert self.tv1.__str__() == 'Power = [False], Channel = [0], Volume = [0]'
        """
        TV is on and volume is increased twice then decreased
        """
        self.tv1.power()
        self.tv1.volume_up()
        self.tv1.volume_up()
